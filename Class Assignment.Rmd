...
Using the caret package, a random forest was run to predict classe in the training set.
```{r, cache = T}
#Fit random forest
set.seed(1258)
...
We now run the random forest on the cross validation set.  The model had a 97.6% accuracy rate with a 95% confidence interval of 97.4% and 97.9%.  This would be our expected out of sample accuracy rate.
